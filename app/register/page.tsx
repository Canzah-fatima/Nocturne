    ...
    <div className="max-w-md mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-24">
      ...
      >
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4" noValidate>
          ...
          <div>
            <label htmlFor="reg-name" className="text-xs font-mono uppercase tracking-wider text-muted">
              Full Name
            </label>
            <div className="mt-1.5 flex items-center gap-2 rounded-xl border border-obsidian-line bg-white/5 px-3.5 py-3 focus-within:border-accent/60 transition-colors">
              <User size={15} className="text-muted shrink-0" aria-hidden="true" />
              <input
                id="reg-name"
                type="text"
                required
          ...
          <div>
            <label htmlFor="reg-email" className="text-xs font-mono uppercase tracking-wider text-muted">
              Email Address
            </label>
            <div className="mt-1.5 flex items-center gap-2 rounded-xl border border-obsidian-line bg-white/5 px-3.5 py-3 focus-within:border-accent/60 transition-colors">
          ...
          <div>
            <label htmlFor="reg-password" className="text-xs font-mono uppercase tracking-wider text-muted">
              Password
            </label>
            <div className="mt-1.5 flex items-center gap-2 rounded-xl border border-obsidian-line bg-white/5 px-3.5 py-3 focus-within:border-accent/60 transition-colors">
            ...
            <p className="text-[11px] font-mono text-muted mt-1.5">Minimum 8 characters.</p>
          </div>
        ...
        <p className="text-xs sm:text-sm text-muted mt-6 text-center">
          ...
          <Link
            href={`/login${nextTarget !== "/profile" ? `?next=${encodeURIComponent(nextTarget)}` : ""}`}
